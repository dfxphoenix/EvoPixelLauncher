...
exports.addCrackedAccount = async function(uuid) {
    try {
        const ret = ConfigManager.addCrackedAuthAccount(uuid)
        ConfigManager.save()
        return ret
...
/**
 * Remove a Cracked account. This will invalidate the access token associated
 * with the account and then remove it from the database.
 * 
 * @param {string} uuid The username of the account to be removed.
...
/**
 * Validate the selected account with Cracked authserver.
 * 
