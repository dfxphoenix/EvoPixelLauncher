...
// TODO change
const dataPath = path.join(sysRoot, '.evopixellauncher')
...
/**
 * Update authenticated cracked account.
 * 
 * @param {string} uuid The username of the authenticated account.
 * 
 * @returns {Object} The authenticated account object created by this action.
 */
exports.updateCrackedAuthAccount = function(uuid){
    config.authenticationDatabase[uuid].uuid = uuid
    config.authenticationDatabase[uuid].type = 'cracked' // For gradual conversion.
    return config.authenticationDatabase[uuid]
}

/**
 * Adds an authenticated cracked account to the database to be stored.
 * 
 ...
 * @returns {Object} The authenticated account object created by this action.
 */
exports.addCrackedAuthAccount = function(uuid){
    config.selectedAccount = uuid
    config.authenticationDatabase[uuid] = {
        type: 'cracked',
        username: uuid.trim(),
		uuid: uuid.trim(),
        displayName: uuid.trim()
    }
    return config.authenticationDatabase[uuid]
}
